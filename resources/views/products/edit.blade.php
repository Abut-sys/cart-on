        ...
        <div class="card-body">
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3"> <!-- Added mb-3 for spacing -->
                    <label for="name" style="font-weight: bold; color: black; margin-bottom: 5px;">Product Name:</label>
                    <input type="text" class="form-control" id="name" name="name" value="{{ $product->name }}" required style="background-color: #dcdcdc; border-color: #c0c0c0;"> <!-- Gray input -->
                </div>

                <div class="form-group mb-3"> <!-- Added mb-3 for spacing -->
                    <label for="description" style="font-weight: bold; color: black; margin-bottom: 5px;">Description:</label>
                    <textarea class="form-control" id="description" name="description" rows="4" style="background-color: #dcdcdc; border-color: #c0c0c0;">{{ $product->description }}</textarea>
                </div>

                <div class="form-group mb-3"> <!-- Added mb-3 for spacing -->
                    <label for="price" style="font-weight: bold; color: black; margin-bottom: 5px;">Price:</label>
                    <input type="number" class="form-control" id="price" name="price" value="{{ $product->price }}" required style="background-color: #dcdcdc; border-color: #c0c0c0;">
                </div>

                <div class="form-group mb-3"> <!-- Added mb-3 for spacing -->
                    <label for="stock" style="font-weight: bold; color: black; margin-bottom: 5px;">Stock:</label>
                    <input type="number" class="form-control" id="stock" name="stock" value="{{ $product->stock }}" required style="background-color: #dcdcdc; border-color: #c0c0c0;">
                </div>
