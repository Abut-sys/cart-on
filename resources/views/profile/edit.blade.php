        ...
        function previewImage(event) {
            ...
            if (file) {
                ...
                reader.onloadend = function () {
                    preview.src = reader.result; // Set gambar sebagai base64 dari FileReader
                ...
                preview.src = "{{ asset('images/default-profile.png') }}"; // Gambar default jika tidak ada file
                preview.style.display = 'block'; // Menampilkan gambar default
            }
        }
