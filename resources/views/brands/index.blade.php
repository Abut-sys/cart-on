    ...
    <div class="container-fluid mt-4">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center"
                ...
                <a href="{{ route('brands.create') }}" class="btn btn-success me-2"
                                ...
                                <table class="brand-index-table table table-striped table-hover w-100">
                                    <thead class="brand-index-thead-light">
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Logo</th>
                                            <th>Category Product</th> <!-- New Category Column -->
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('storage/' . $brand->logo_path) }}"
                                                        alt="Logo {{ $brand->name }}" width="50"
                                                        class="brand-index-logo">
                                                </td>
                                                <td>{{ $brand->category->name ?? 'N/A' }}</td> <!-- Display Category -->
                                                <td>
                                                    <a href="{{ route('brands.edit', $brand->id) }}"
                                                        class="brand-index-btn-edit-brand btn btn-warning btn-sm"
                                                        title="Edit">
