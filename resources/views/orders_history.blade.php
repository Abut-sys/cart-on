                ...
                <div class="th-content-wrapper">
                    ...
                    <div class="th-transaction-card">
                        <div class="th-transaction-header">
                            <div class="th-meta-group">
                                <h3 class="th-transaction-id">TRX-{{ strtoupper(substr($checkout->transaction_id, 0, 8)) }}</h3>
                    ...
                    <div class="th-empty-state">
                        <div class="th-empty-logo">
                            <svg xmlns="http://www.w3.org/2000/svg" class="th-empty-icon" viewBox="0 0 24 24" stroke-width="1.5">
